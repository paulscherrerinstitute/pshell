...
public class Str {
        ...
        if (obj != null) {
            if (obj instanceof List list) {
                ...
                for (Object key : map.keySet()) {
                    list.add(String.valueOf(key) + "=" + toString(map.get(key), maxElements));
                }
                obj = list.toArray();
                sj = new StringJoiner(", ", "{", "}");
            }
     ...
     */
    public static String[] splitWithQuotes(String str, String separator) {
        return splitWithQuotes(str, separator, isDoubleQuotes(str));
    }
    /**
     * Split strings ignoring separators in quotes
     */
    public static String[] splitWithQuotes(String str, String separator, boolean doubleQuotes) {
        String[] ret ;
        if (doubleQuotes) {
    ...
    public static String[] splitRemoveQuotes(String str, String separator) {
        return splitRemoveQuotes(str, separator, isDoubleQuotes(str));
    }
    
    public static String[] splitRemoveQuotes(String str, String separator, boolean doubleQuotes) {
        String[] ret = splitWithQuotes(str, separator, doubleQuotes);
        for (int i=0; i<ret.length;i++){
            ret[i] = removeQuotes(ret[i], doubleQuotes);
        }
        return ret;
    }

    public static String removeQuotes(String str) {
        return removeQuotes(str, isDoubleQuotes(str));
    }
    
    public static String removeQuotes(String str, boolean doubleQuotes) {
    ...
    public static String removeSuroundingQuotes(String str) {
        return removeQuotes(str, isDoubleQuotes(str));
    }
    
    public static String removeSuroundingQuotes(String str, boolean doubleQuotes) {
        String quote = doubleQuotes ? "\"" : "'";
        str = str.trim();
