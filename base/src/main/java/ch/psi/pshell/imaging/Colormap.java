...
public enum Colormap {
    ...
    Grayscale, Red, Green, Blue, Inverted, Temperature, Rainbow, Flame, Viridis;
    ...
    public Color getColor(double val, double min, double max) {
        ...
        switch (this) {
            ...
            case Viridis: 
                return new Color(viridisColormapTable[byteValue][0], viridisColormapTable[byteValue][1], viridisColormapTable[byteValue][2]);
            case Rainbow:
