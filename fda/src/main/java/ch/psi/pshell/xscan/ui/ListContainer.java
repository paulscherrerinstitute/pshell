...
//                panels.add(i);
    ...
    /**
     * Move list element up in the list. If element is already the first one do nothing
     *
     * @param element
     */
    ...
    /**
     * Move list element down in the list. If the element is already the last one do nothing.
     *
     * @param element
     */
