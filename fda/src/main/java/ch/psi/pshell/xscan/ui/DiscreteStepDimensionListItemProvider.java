...
public class DiscreteStepDimensionListItemProvider implements ListItemProvider<DiscreteStepDimension> {
    ...
    public void removeItem(Component component) {
        if (component instanceof DiscreteStepDimensionPanel discreteStepDimensionPanel) {
            list.remove(discreteStepDimensionPanel.getObject());
        }
    }
    ...
    private Object getObject(Component component) {
        if (component instanceof DiscreteStepDimensionPanel discreteStepDimensionPanel) {
            return (discreteStepDimensionPanel.getObject());
        }
        return null;
    }
