...
public class ChannelParameterMappingListItemProvider implements ListItemProvider<ChannelParameterMapping> {
    ...
    public void removeItem(Component component) {
        if (component instanceof ChannelParameterMappingPanel channelParameterMappingPanel) {
            list.remove(channelParameterMappingPanel.getObject());
        }
    }
    ...
    private Object getObject(Component component) {
        if (component instanceof ChannelParameterMappingPanel channelParameterMappingPanel) {
            return (channelParameterMappingPanel.getObject());
        }
        return null;
    }
}
