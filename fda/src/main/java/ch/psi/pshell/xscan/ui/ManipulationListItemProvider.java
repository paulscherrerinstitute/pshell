...
public class ManipulationListItemProvider implements ListItemProvider<Manipulation> {
    ...
    private Component getItem(Manipulation object) {
        if (object instanceof ScriptManipulation scriptManipulation) {
            ScriptManipulationPanel p = new ScriptManipulationPanel(scriptManipulation);
    ...
    public void removeItem(Component component) {
        if (component instanceof ScriptManipulationPanel scriptManipulationPanel) {
            ScriptManipulation o = scriptManipulationPanel.getObject();
            list.remove(o);
    ...
    private Object getObject(Component component) {
        if (component instanceof ScriptManipulationPanel scriptManipulationPanel) {
            return scriptManipulationPanel.getObject();
        }
        return null;
    }
}
