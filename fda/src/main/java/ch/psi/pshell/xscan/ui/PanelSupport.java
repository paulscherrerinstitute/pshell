...
public class PanelSupport {
    ...
    public void analyze(HashMap<Component, ComponentMetadata> fields) {
        for (Component field : fields.keySet()) {
            if (field instanceof JTextField f) {
                String label = f.getText();
                if (label != null && !label.trim().equals("")) {
                    fieldLabels.put(field, label);
                }
            } else if (field instanceof JFormattedTextField f) {
                String label = f.getText();
                if (label != null && !label.trim().equals("")) {
                    fieldLabels.put(field, label);
                }
...
//            }
    ...
    private void checkVisibility(Component field, String defaultValue) {
        ...
        } else if (field instanceof JTextArea f) {
            if (f.getText().trim().equals(defaultValue) || f.getText().trim().equals("")) {
                hide = true;
            }
        } else if (field instanceof JComboBox b) {
        ...
        } else if (field instanceof JCheckBox box) {
            if (!box.isSelected()) {
                hide = true;
            }
        }
                    ...
                    item.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent ae) {
                            ...
                            if (c instanceof JCheckBox cb) {
                                ...
                                tc.setText(optionalFields.get(c).getDefaultValue());
                            }
