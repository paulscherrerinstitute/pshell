...
public class LineScan extends DiscreteScan {
    ...
    public static class LineScanStepSize extends LineScan{
        public LineScanStepSize(Writable[] writables, Readable[] readables, double[] start, double[] end, double stepSize[],
            boolean relative, int latency, int passes, boolean zigzag) {
            super(writables, readables, start, end, stepSize, relative, latency, passes, zigzag);
        }        
    }
    public static class LineScanNumSteps extends LineScan{
        public LineScanNumSteps(Writable[] writables, Readable[] readables, double[] start, double[] end, int numberOfSteps,
            boolean relative, int latency, int passes, boolean zigzag) {
            super(writables, readables, start, end, numberOfSteps, relative, latency, passes, zigzag);
        }        
    }
