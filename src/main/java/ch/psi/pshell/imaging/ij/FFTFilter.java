...
/**
 * This class implements the Process/FFT/bandpass Filter command. It started out as Joachim Walter's
 * FFT Filter plugin at "http://rsb.info.nih.gov/ij/plugins/fft-filter.html". 2001/10/29: First
 * Version (JW) 2003/02/06: 1st bugfix (works in macros/plugins, works on stacks, overwrites
 * image(=>filter)) (JW) 2003/07/03: integrated into ImageJ, added "Display Filter" option (WSR)
...
public class FFTFilter implements PlugInFilter, Measurements {
    ...
    public static double filterLargeDia = 40.0;
    public static double filterSmallDia = 3.0;
    public static int choiceIndex = 0;
    //public static String[] choices = {"None","Horizontal","Vertical"};
    //public static String choiceDia = choices[0];
    public static double toleranceDia = 5.0;
    public static boolean doScalingDia = true;
    public static boolean saturateDia = true;
    public static boolean displayFilter;
    public static boolean processStack;
    ...
    /**
     * Puts imageprocessor (ROI) into a new imageprocessor of size width x height y at position
     * (x,y). The image is mirrored around its edges to avoid wrap around effects of the FFT.
     */
