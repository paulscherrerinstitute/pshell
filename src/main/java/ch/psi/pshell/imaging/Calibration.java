...
public class Calibration implements Serializable {
    ...
    public Calibration(MatrixCalibration c) {
        //Image calibration is different from axis callibration: first image is moved to center and then scaled
        this(c.scaleX, c.scaleY, c.offsetX / c.scaleX, c.offsetY / c.scaleY);
    }
