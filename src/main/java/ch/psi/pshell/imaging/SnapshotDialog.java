...
public class SnapshotDialog extends StandardDialog {
    ...
    void grab() throws IOException {
        String folder = Context.getInstance().getSetup().expandPath(textFolder.getText());
    ...
    void start() throws IOException {
        ...
        index = (Integer) spIndex.getValue();
        final String folder = Context.getInstance().getSetup().expandPath(textFolder.getText());
    ...
    private void buttonSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSetActionPerformed
        try {
            ...
            JFileChooser chooser = new JFileChooser(Context.getInstance().getSetup().expandPath(textFolder.getText()));
    ...
    private void buttonBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBrowseActionPerformed
        try {
            ...
            File file = new File(Context.getInstance().getSetup().expandPath(textFolder.getText()));
