...
public abstract class CameraBase extends DeviceBase implements Camera {
    ...
    ImageRegister matrix;

    public CameraBase(String name) {
        super(name);
        matrix = new ImageRegister(name + "_matrix");
    }
    ...
    class ImageRegister extends ReadonlyRegisterBase implements ReadonlyRegisterMatrix, ReadableCalibratedMatrix {

        public ImageRegister(String name) {
            super(name);
        }
