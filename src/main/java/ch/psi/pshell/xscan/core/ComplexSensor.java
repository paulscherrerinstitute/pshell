...
/**
 * Complex sensor that complements an other sensor with pre and post actions. Before reading out the complemented sensor
 * the pre actions are executed. After the readout the post actions.
 */
