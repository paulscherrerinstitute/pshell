...
public class CollapsibleContainer extends javax.swing.JPanel {
     ...
     *                      The name of the icon is just the icon file name withou the .png suffix.
     *                      For example "photo" will load the photo.png in the ch.psi.pshell.xscan.ui.icons package.
     * @param component     Panel that should be collapsible
     */
    ...
    /**
     * Set the additional header for this component
     * This field is used to e.g. show how many items are inside the container
     * [1,2,3,...]
     * @param text
     */
