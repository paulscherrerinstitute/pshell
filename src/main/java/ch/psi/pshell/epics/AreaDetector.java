...
public class AreaDetector extends CameraBase {
    ...
    public AreaDetector(final String name, final String channelCtrl, final String channelData) {
        ...
        acquire = new ChannelInteger(name + " acquire", channelCtrl + ":Acquire");
        //imageSizeX = new ChannelInteger(name + " size x rdb", channelCtrl + ":ArraySizeX_RBV");
        //imageSizeY = new ChannelInteger(name + " size y rdb", channelCtrl + ":ArraySizeY_RBV");
        arraySize0 = new ChannelInteger(name + " array size 0", channelData + ":ArraySize0_RBV");
        arraySize1 = new ChannelInteger(name + " array size 1", channelData + ":ArraySize1_RBV");
        arraySize2 = new ChannelInteger(name + " array size 2", channelData + ":ArraySize2_RBV");
        colorMode = new ChannelString(name + " color mode", channelCtrl + ":ColorMode");
        dataType = new ChannelString(name + " data type", channelCtrl + ":DataType");
        minX = new ChannelInteger(name + " min x", channelCtrl + ":MinX");
        minY = new ChannelInteger(name + " min x", channelCtrl + ":MinY");
        sizeX = new ChannelInteger(name + " size x", channelCtrl + ":SizeX");
        sizeY = new ChannelInteger(name + " size y", channelCtrl + ":SizeY");
        imageCounter = new ChannelInteger(name + " img counter", channelCtrl + ":ArrayCounter_RBV");
