...
public class CPythonDialog extends StandardDialog {
    ...
    public CPythonDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setTitle("CPython");
        initComponents();
    ...
    void setDefaults() {
        try {
            ...
            String installPath = Context.getInstance().getSetup().expandPath((pythonHome!=null) ? pythonHome : "{home}/cpython");
    ...
    void install() {
        try {            
            ...
            App.getInstance().startTask(new CPythonInstall());
        ...
        protected String doInBackground() throws Exception {
            ...
            try {
                ...
                if (!version.isBlank()) {
                    ...
                    splash = SwingUtils.showSplash(App.getInstance().getMainFrame(), "Install", new Dimension(400, 200), "Installing CPython...");
                    try {
                ...
                setMessage(msg);
                setProgress(50);
                splash = SwingUtils.showSplash(App.getInstance().getMainFrame(), "Install", new Dimension(400, 200), "Installing Packages...");
                try {
                ...
                SwingUtils.showScrollableMessage(App.getInstance().getMainFrame(), "CPython", "Success installing Python", String.join("\n\n", new String[]{r1, r2, r3}));
