...
public class CameraCalibrationDialog extends StandardDialog {
    ...
    public CameraCalibrationDialog(Frame parent, String cameraServer, String cameraName, Renderer renderer) throws IOException {
    ...
    public static void main(String args[]) throws Exception {
        App.init(args);        
        String cameraName = App.getArgumentValue("cam");                

        Renderer renderer = new Renderer();
        JDialog dlgRenderer = SwingUtils.showDialog(null, cameraName, new Dimension(600,400), renderer);
        CameraCalibrationDialog dialog = new CameraCalibrationDialog(null, App.getArgumentValue("camera_server"), cameraName, renderer);
