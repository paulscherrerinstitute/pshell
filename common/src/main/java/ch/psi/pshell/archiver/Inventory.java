...
public class Inventory {
    ...
    public static List<Double> getCalibFromInventory(String part_label, String holy_name) throws IOException {
        ...
        for (Map a : attributes) {
            ...
            switch (name) {
                case "Crystal angle in x (e-beam system) [deg]" -> horizontal_tilt = val;
                case "Crystal angle in y (e-beam system) [deg]" -> vertical_tilt = val;
                case "Mark distance in x (e-beam system) [mm]" -> horizontal_dist = val;
                case "Mark distance in y (e-beam system) [mm]" -> vertical_dist = val;
            }
        }
