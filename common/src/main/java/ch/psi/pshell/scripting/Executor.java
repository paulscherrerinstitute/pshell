...
public class Executor {
    ...
    public Executor(ScriptEngine engine, ScriptType type, Bindings bindings) {
        this.engine = engine;
        this.type = type;
    ...
    public InterpreterResult eval(String line, boolean batch) {
            ...
            if ((tryFilterException) && (se.getCause() != null)) {
                ...
                switch (type) {
                    case js:
                        ...
                        break;
                    case py:
                        if (se.getCause() instanceof org.python.core.PySyntaxError pex) {                           
                        ...
                        break;
                    case cpy:
                      if (se.getCause() instanceof jep.JepException jex) {   
                        ...
                        break;
                    case groovy:
                        if (se.getCause() instanceof org.codehaus.groovy.control.CompilationFailedException pex) {
