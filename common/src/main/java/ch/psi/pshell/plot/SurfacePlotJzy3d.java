    ...
    */
    ...
    org.jzy3d.plot3d.rendering.canvas.Quality getJzy3dQuality() {
        return switch (getQuality()) {
            case Low -> org.jzy3d.plot3d.rendering.canvas.Quality.Fastest();
            case Medium -> org.jzy3d.plot3d.rendering.canvas.Quality.Intermediate();
            case High -> org.jzy3d.plot3d.rendering.canvas.Quality.Advanced();
            case Maximum -> org.jzy3d.plot3d.rendering.canvas.Quality.Nicest();
            default -> null;
        };
    }
    ...
    public enum Mode {
        ...
        private org.jzy3d.plot3d.rendering.view.modes.ViewPositionMode toJzy3dMode() {
            return switch (this) {
                case Top -> org.jzy3d.plot3d.rendering.view.modes.ViewPositionMode.TOP;
                case Profile -> org.jzy3d.plot3d.rendering.view.modes.ViewPositionMode.PROFILE;
                case Free -> org.jzy3d.plot3d.rendering.view.modes.ViewPositionMode.FREE;
                default -> null;
            };
        }
    }
    ...
    void createGraph() {
        synchronized (chartLock) {
            ...
            if (series != null) {
                ...
                if (canvas instanceof IScreenCanvas screenCanvas) {
            ...
            if (series == null) {
                ...
                if ((surface == null) || (newSeries) || getAxis(AxisId.Z).isAutoRange() || changedBoundsZ) {
                    ...
                    if (getContour() != Contour.None) {
                        ...
                        switch (getContour()) {
                            case Normal -> cab.setContourImg(contour.getContourImage(policy, xRes, yRes, getContourLevels()), rangeX, rangeY);
                            case Filled -> cab.setContourImg(contour.getFilledContourImage(policy, xRes, yRes, getContourLevels()), rangeX, rangeY);
                            case HeightMap -> cab.setContourImg(contour.getHeightMap(policy, xRes, yRes, getContourLevels()), rangeX, rangeY);
                            case Contour3D -> {
