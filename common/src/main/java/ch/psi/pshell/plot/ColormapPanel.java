...
public class ColormapPanel extends MonitoredPanel {
    ...
    public void setPosition(Position pos) {
        ...
        if (legend != null) {
            switch (position) {
                case LEFT -> legend.setPosition(RectangleEdge.LEFT);
                case RIGHT -> legend.setPosition(RectangleEdge.RIGHT);
                case TOP -> legend.setPosition(RectangleEdge.TOP);
                case BOTTOM -> legend.setPosition(RectangleEdge.BOTTOM);
            }
        }
    }
