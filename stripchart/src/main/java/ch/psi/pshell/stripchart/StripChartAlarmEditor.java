...
public class StripChartAlarmEditor extends StandardDialog {
    ...
    public StripChartAlarmEditor(java.awt.Window parent, boolean modal, StripChartAlarmConfig config, String channel) {
        super(parent, modal);
        initComponents();
    ...
    private void buttonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOkActionPerformed
        try {
            ...
            Double lowLimit = switch (comboLowLimit.getSelectedIndex()) {
                case 0 ->  null;
                case 1 ->  Double.valueOf(textLow.getText());
                case 2 ->  Double.NaN;
                default -> null;
            };
            Double highLimit = switch (comboHighLimit.getSelectedIndex()) {
                case 0 -> null;
                case 1 -> Double.valueOf(textHigh.getText());
                case 2 -> Double.NaN;
                default -> null;
            };
