 ...
 *
 */
public class ScriptEditor extends StandardDialog {
    ...
    public ScriptEditor(java.awt.Window parent, boolean modal, String name, String script, String syntax) {
        super(parent, modal);
        initComponents();
    ...
    private void buttonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOkActionPerformed
        try {            
            ret = editorPane.getText();
            if (ret.equals(script)){
                cancel();
            } else {
                if (syntax.equals(SyntaxConstants.SYNTAX_STYLE_JSON)){
                    Map<String, Object> map = (Map) JsonSerializer.decode(ret, Map.class);
                }
                accept();
            }
        } catch (Exception ex) {
