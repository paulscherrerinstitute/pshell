...
import ch.psi.pshell.swing.FontDialog;
import ch.psi.pshell.swing.StandardDialog;
import ch.psi.pshell.swing.SwingUtils;
import ch.psi.pshell.workbench.Preferences.FontSpec;
...
public class PreferencesDialog extends StandardDialog {
    ...
    public PreferencesDialog(java.awt.Window parent, boolean modal) {
        super(parent, modal);
        ...
        SwingUtils.setEnumCombo(comboScriptPopup, ScriptPopupMode.class);
    ...
    public void set(Preferences preferences) throws Exception {
        ...
        comboScriptPopup.setSelectedItem(preferences.getScriptPopupMode());
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(comboConsoleLocation, 0, 108, Short.MAX_VALUE)
    ...
    private void buttonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOkActionPerformed
        try {
            if (preferences != null) {
                ...
                ScriptPopupMode scriptPopup = (ScriptPopupMode) comboScriptPopup.getSelectedItem();
    ...
    private javax.swing.JCheckBox ckAsyncPlotsUpdate;
