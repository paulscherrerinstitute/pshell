...
DeviceConfig = Java.type('ch.psi.pshell.device.DeviceConfig')
...
Register = Java.type('ch.psi.pshell.device.Register') 
...
Cacheable = Java.type('ch.psi.pshell.device.Cacheable') 
...
Threading =  Java.type('ch.psi.pshell.utils.Threading')
Convert =  Java.type('ch.psi.pshell.utils.Convert')
Arr =  Java.type('ch.psi.pshell.utils.Arr')
Chrono =  Java.type('ch.psi.pshell.utils.Chrono')
State =  Java.type('ch.psi.pshell.utils.State')
...
function on_command_finished(info) {
}

function on_session_started(id) {
}

function on_session_finished(id) {
}

function on_change_data_path(path) {
}
