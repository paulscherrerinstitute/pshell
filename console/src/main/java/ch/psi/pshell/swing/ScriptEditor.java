...
public class ScriptEditor extends MonitoredPanel implements Executor {
    ...
    public ScriptEditor(boolean syntaxHighlight, boolean showLineNumbers, boolean showContextMenu) {
        ...
        if (syntaxHighlight) {
            ...
            codeEditor.setType(Context.getScriptType().getExtension());
        ...
        editor.setFileChooserFolder(Setup.getScriptsPath());
    ...
    public void saveAs(String filename) throws IOException {
        ...
        setScriptName(new File(filename).getName());
        isScript = Context.getScriptType().getExtension().equals(IO.getExtension(filename));
    }
        ...
        try {
            ...
            if (key == KeyEvent.VK_UP) {
                ...
                if (popupAutoComp != null) {
                    ...
                    List<String> signatures = InterpreterUtils.getSignatures(editor.getCanonicalText(), editor.getEditor().getCaretPosition(), propagateVariableEvaluation);
                    if (signatures != null) {
    ...
    public void comment(){ 
        getTextEditor().addPrefixToSelection(Context.getScriptType().getLineCommentMarker());   
    }    
    
    public void uncomment(){ 
        getTextEditor().removePrefixFromSelection(Context.getScriptType().getLineCommentMarker());
    }        
    ...
    private void initComponents() {
        ...
        editor = new ch.psi.pshell.swing.TextEditor();
    ...
    private ch.psi.pshell.swing.TextEditor editor;
