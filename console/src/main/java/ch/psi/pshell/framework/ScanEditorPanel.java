...
public class ScanEditorPanel extends MonitoredPanel implements Processor {
    ...
    public void open(String fileName) throws IOException {
        ...
        comboFormat.setSelectedItem(String.valueOf(getStateElement(state, 16, String.class)).trim());
    ...
    public void saveAs(String fileName) throws IOException {
        ...
        state.add(comboFormat.getSelectedItem());
    ...
    protected void update() {
        ...
        comboFormat.setEnabled(enabled && checkSave.isSelected());
        ...
        switch (cmd) {
            case "tscan" -> labelLatency.setText("Interval (s):");
            default -> labelLatency.setText("Latency (s):");
        }
    ...
    List<String> getPositioners() {
        ...
        if (hasPositioners()) {
            for (int i = 0; i < modelPositioners.getRowCount(); i++) {
                ...
                switch (type) {
                    case Channel -> ret.add("'ca://" + name + "'");
                    case Device -> ret.add(name);
                    default -> throw new RuntimeException("Invalid positioner type");
                }
            }
        }
        return ret;
    ...
    String getParName(String par) {
        if (Context.getScriptType() == ScriptType.js) {
            return "";
        }
        return par + "=";
    }
    ...
    List<String> getParameters() {
        ...
        boolean addSpacersCommas = (Context.getScriptType() == ScriptType.js);
        List<String> ret = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(comboLayout, 0, 96, Short.MAX_VALUE)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(spinnerPasses, javax.swing.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)
