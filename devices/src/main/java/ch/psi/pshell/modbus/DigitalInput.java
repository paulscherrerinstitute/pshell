...
import ch.psi.pshell.device.ReadonlyRegister.ReadonlyRegisterBoolean;
 ...
 */
public class DigitalInput extends ReadonlyRegisterBase<Boolean> implements ReadonlyRegisterBoolean, BooleanType {
