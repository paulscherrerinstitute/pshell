...
public class DevicePoolParametersEditor extends StandardDialog {
    ...
    public DevicePoolParametersEditor(java.awt.Window parent, boolean modal, Class type, String value, HashMap<String, Class> referencedDevices) {
        super(parent, modal);
        initComponents();
    ...
    void init(Window parent, Class type, String value, HashMap<String, Class> referencedDevices) {
        ...
        textConstructors.setBackground(TextEditor.getDisabledBackgroundColor());
        textClass.setBackground(TextEditor.getDisabledBackgroundColor());
        ...
        if (updating.compareAndSet(false, true)) {
            try {
                ...
                for (int i = 0; i < constructors.size(); i++) {
                    ...
                    if (DevicePool.getInstance().getAdjustedArguments(c, pars, referencedDevices) != null) {
