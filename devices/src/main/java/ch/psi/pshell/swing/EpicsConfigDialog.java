...
public class EpicsConfigDialog extends StandardDialog {
    ...
    final FilePermissions configFilePermissions;
    boolean readOnly;
    ...
    public EpicsConfigDialog(java.awt.Window parent, boolean modal, FilePermissions configFilePermissions) {
        super(parent, modal);
        initComponents();
    ...
    void save() throws Exception {
        ...
        try (FileOutputStream out = new FileOutputStream(Epics.getConfigFile())) {
            ...
            IO.setFilePermissions(Epics.getConfigFile(), configFilePermissions);
        }        
    }
    ...
    public void setReadOnly(boolean value) {
        ...
        for (Component c : this.getContentPane().getComponents()) {
            if (c instanceof JTextComponent jTextComponent) {
                jTextComponent.setEditable(!value);
            }
        }
    }
