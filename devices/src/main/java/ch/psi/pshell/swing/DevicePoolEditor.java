    ...
    public static class DevicePoolDocument extends Document {
                ...
                private final Action parsEditAction = new AbstractAction("...") {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (parent instanceof Dialog dialog) {
                            dlg = new DevicePoolParametersEditor(dialog, true, type, field.getText(), referencedDevices);
                        } else {
        ...
        String[] getKnownClassNames() {
            List<String> knownClasses = new ArrayList(Arrays.asList(new String[]{
                ...
                ch.psi.pshell.device.MasterPositioner.class.getName(),
                ...
                ch.psi.pshell.camserver.CameraSource.class.getName(),
                ch.psi.pshell.camserver.CameraStream.class.getName(),
                ch.psi.pshell.camserver.PipelineSource.class.getName(),
                ch.psi.pshell.camserver.PipelineStream.class.getName(),
                ch.psi.pshell.camserver.CamServerService.class.getName(),
